...
export default function LockedDocumentViewer({ content }: LockedDocumentViewerProps) {
  ...
  return (
    <div className="relative border border-gray-300 p-8 min-h-[600px] bg-white locked-document-viewer overflow-hidden">
      ...
      <div 
        className="absolute inset-0 pointer-events-none opacity-[0.04] flex items-center justify-center text-center z-0"
        style={{ 
          backgroundImage: 'url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'350\' height=\'350\'><text x=\'50%\' y=\'50%\' font-size=\'22\' font-weight=\'bold\' fill=\'black\' text-anchor=\'middle\' transform=\'rotate(-45 175 175)\'>PREVIEW ONLY - RS.KABALEONLINE</text></svg>")',
